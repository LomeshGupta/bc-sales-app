...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <Box sx={{ position: 'absolute', top: -100, right: -100, width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(211,47,47,0.06) 0%, transparent 70%)', pointerEvents: 'none' }} />
      <Box sx={{ position: 'absolute', bottom: -150, left: -100, width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(211,47,47,0.04) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      >
        ...
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          >
            ...
            >
              <Box component="span" sx={{ color: 'white', fontWeight: 800, fontSize: '1.5rem', fontFamily: '"DM Sans", sans-serif' }}>
                BC
              </Box>
            </Box>
          </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25, type: 'spring', stiffness: 200, damping: 25 }}>
          <Card sx={{ border: '1px solid', borderColor: 'divider', boxShadow: isDark ? '0 24px 80px rgba(0,0,0,0.6)' : '0 24px 80px rgba(0,0,0,0.12)' }}>
            <CardContent sx={{ p: 3.5, '&:last-child': { pb: 3.5 } }}>
              ...
              <Box component="form" onSubmit={handleLogin} noValidate>
                    ...
                    input: {
                      ...
                      endAdornment: (
                        <InputAdornment position="end">
                          <IconButton edge="end" onClick={() => setShowPassword(!showPassword)} size="small">
                ...
                <Button type="submit" fullWidth variant="contained" size="large" disabled={isLoading} sx={{ py: 1.5, fontSize: '1rem' }}>
                  {isLoading ? (
